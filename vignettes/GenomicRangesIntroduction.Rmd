---
title: "An Introduction to the GenomicRangesGHA Package"
author: "Marc Carlson, Patrick Aboyoun, Hervé Pagès, and Martin Morgan"
date: "`r format(Sys.time(), '%B %d, %Y')`"
vignette: >
  %\VignetteIndexEntry{1. An Introduction to the GenomicRangesGHA Package}
  %\VignetteKeywords{sequence, sequencing}
  %\VignettePackage{GenomicRangesGHA}
...
The `r Biocpkg("GenomicRangesGHA")` package serves as the foundation for
...
The `r Biocpkg("GenomicRangesGHA")` package is available at
...
The `r Biocpkg("GenomicRangesGHA")` help page `?"intra-range-methods"`
...
See the `r Biocpkg("GenomicRangesGHA")` help page
...
The `r Biocpkg("GenomicRangesGHA")` package provides multiple functions to
