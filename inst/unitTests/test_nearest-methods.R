...
{
    .findNearest <- GenomicRangesGHA:::.GenomicRanges_findNearest0
    sentinel <- c(0, 20)
    subject <- c(5, 15)
...
test_GenomicRanges_nearestKNeighbors_all_k <- function()
{
    ...
    x <- IntegerList()
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 0), integer(length(x)))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 1), integer(length(x)))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 2), integer(length(x)))
    ...
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 0), integer(length(x)))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 1), c(0L, 1L))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 2), c(0L, 1L))

    ## essential functionality
    x <- IntegerList(1L)
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 0), integer(length(x)))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 1), 1L)
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 2), 1L)

    x <- IntegerList(1L, 1:2)
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 0), integer(length(x)))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 1), c(1L, 1L))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 2), 1:2)
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 3), 1:2)

    ## ties
    x <- IntegerList(1:2, c(1L, 1:2)) # ties at start
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 0), integer(length(x)))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 1), 1:2)
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 2), c(2L, 2L))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 3), c(2L, 3L))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 4), c(2L, 3L))

    x <- IntegerList(1:2, c(1:2, 2L)) # ties at end
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 0), integer(length(x)))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 1), c(1L, 1L))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 2), c(2L, 3L))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 3), c(2L, 3L))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 4), c(2L, 3L))
    ...
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 1), 1:2)
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 2), c(2L, 2L))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 3), c(2L, 4L))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 4), c(2L, 4L))
    checkIdentical(GenomicRangesGHA:::.nearestKNeighbors_all_k(x, 5), c(2L, 4L))
}
